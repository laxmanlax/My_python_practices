...
#{"host": [{"GET": [{"200": statuscount, "500": statuscount, "400": statuscount}, reqestCount], "POST": [{"200": statuscount, "500": statuscount, "400": statuscount}, reqestCount], "DELETE": [{"200": statuscount, "500": statuscount, "400": statuscount}, reqestCount]}, hostcount]}
allStatus = {}
allRequests = {}
...
for line in f:
    ...
    if str(host) not in processData.keys():
        ...
        if rType not in processData[host][1]:
            ...
            #print status, rCount, processData[host][1][rType]
